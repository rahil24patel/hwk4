...
- Estimated hospital prices based on the formula taught in class: discounted inpatient, ICU,
  and ancillary charges minus total Medicare payments, scaled by non-Medicare
  discharges. Negative and infinite prices were dropped.
...
- Built a cross-sectional IV dataset linking 2011 and 2014 prices, 2012 net
  ...
  discharges. Medicare discharges are scaled to hundreds to make it easier to interpret
